...
public class TC08_CheckUpdateWhenApprStrtDateClosed extends LoginPage
{
	...
	{    
		...
		try{
			...
			if(rp.getApprStartDate().isEnabled())
			{
				System.out.println("CLosed Approval Start Date Is Not Grayed And Able to Edit the Date");
			}}catch(Exception e)
			{
				System.out.println("Closed Approval Start Date Is Grayed And Unable to Edit the Date");
			}
